	...
	export default {
      ...
      ...mapMutations(['setCartNum']),
			...
			initData(options) {
			  let params = {};
			  if (options.cate_id) {
					params.productCategoryId = options.cate_id;
			  }
				if (options.param) {
			...
			btnDropChange(e) {
				...
				let params = {};
				if (this.attrArr[0]&&this.attrArr[0].isActive) {
					params = {};
				} else {
