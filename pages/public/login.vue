...
export default {
	...
	methods: {
		...
		async toLogin() {
			...
			this.reqBody['telephone'] = this.loginParams['mobile'];
			let cheRes, loginApi;
			if (this.loginByPass) {
				...
				this.reqBody['authCode'] = this.loginParams['code'];
				...
				.then(r => {
					...
					this.$mStore.commit('login', r.data);
					 this.$http
						.get('/sso/info',{})
						.then(r=>{
							this.$mStore.commit('userInfo', r.data);
							console.log(r.data)
							if (this.userInfo) {
